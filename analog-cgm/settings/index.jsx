  ...
  return (
    ...
    <Page>
      ...
      <Section title={<Text bold align="center">Periodic comet settings:</Text>}>
        <Text>A comet can be setup to appear on the watch face after a set period of time.
  ...
  onClick={() => { props.settingsStorage.setItem("change", JSON.stringify("now"))}} />
      ...
      <Text align="left" bold>1.2</Text>
        <Text>Added Nightscout token support.  Added automatic watch face display turn on when alarms happen.</Text>
            ...
            <Text>
              Fixed bug with displaying alarm notices.
              Added colors for "Urgent High", "High", "Low" and "Urgent Low".
            ...
            <Text align="left" bold>1.3.1</Text>
            <Text>
              Fixed bug with displaying alarm notices.
	      Fixed problem with graph size on Versa.
		...
		Fixed bug whereby wrong alarm note message would be presented.
            ...
            <Text>
              Fixed major build problem with Urgent High & Low and Graph display.
            </Text>
            <Text align="left" bold>1.5</Text>
            <Text>
              Changed name to "Analog CGM".
	      ...
	      Introduced "Local mode" to support "127.0.0.1" usage direct to the phone.
            ...
            <Text align="left" bold>1.5.3</Text>
            <Text>
