    ...
    return (
        ...
        <Page>
          ...
          <Section title={<Text bold align="center">Periodic comet settings:</Text>}>
            ...
            <Button
              ...
              <TextInput settingsKey="cometDays" label="Reappear after X days/hours" type="text" />
        ...
        <Text>After selecting "local mode", select either the XDrip+ or the Spike version, depending upon
	      ...
	      Introduced "Local mode" for direct "127.0.0.1" connection to the phone.
            ...
            <Text align="left" bold>1.7.1</Text>
            <Text>
            ...
            <Text align="left" bold>1.7.2</Text>
            <Text>
...
Fixed problem with reloading alarm notes after a reboot, reduced memory usage a little more.
            ...
            <Text align="left" bold>1.8.5</Text>
            <Text>
...
Enable Always On Display capability.
            ...
            <Text align="left" bold>2.0.1</Text>
            <Text>
                Make moon more visible in AOD mode.
                Make asteroid tumble when not in AOD mode.
                Separate "Save Config" and "Restore Config" to make them more usable.
            </Text>
            <Text align="left" bold>3.0.0</Text>
            <Text>
		New version with support for Versa 3 and Sense watches.
            </Text>
            <Text align="left" bold>3.0.1</Text>
            <Text>
                Added "Reset Interval" to menu, to allow resetting the interval when no Internet connection is present.
                Added automatic checking of CGM uploader battery level every 15 minutes.
            </Text>
            <Text align="left" bold>3.1.0</Text>
...
Display Nightscout arrow or actual difference number by touching in that corner.
        Minor bug fixes.
            <Text>
            </Text>
          </Section>
